...
const languageStrings = {
  'en': {
    ...
    "weather-app-text": `A simple weather app that returns weather conditions to any desired place.`,
  ...
  "pt-br": {
    ...
    "weather-app-text": `Um aplicativo web simples que mostra as condições do tempo em qualquer cidade ou país.`,
